  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-background text-foreground">
      ...
      <main className="flex-1 pt-14">
        {/* Home */}
        <section id="home" className="container mx-auto px-4 py-12 md:px-6 md:py-16">
          <div className="mx-auto max-w-3xl grid grid-cols-2 gap-6"  style={{paddingTop : "3rem"}}>
        ...
        {/* Experiences */}
        <section id="experiences" className="container mx-auto px-4 py-12 md:px-6 md:py-16" data-aos="fade-up" data-aos-duration="1500" data-aos-mirror="true">
        ...
        {/* Education */}
        <section id="education" className="container mx-auto px-4 py-12 md:px-6 md:py-16" data-aos="fade-up" data-aos-duration="1500" data-aos-mirror="true">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 space-y-8">
              <div className="flex items-start group">
                <img
                  ...
                  width={64}
                  height={64}
                  className="mr-4 h-14 w-14 text-muted-foreground group-hover:border group-hover:border-[#ff69b4] group-hover:rounded-md"
                />
                <div>
                  <h3 className="text-lg font-semibold group-hover:text-[#ff69b4]">
        ...
        {/* Contact */}
        <section id="contact" className="container mx-auto px-4 py-12 md:px-6 md:py-16" data-aos="fade-up" data-aos-duration="1500" data-aos-mirror="true">
          <ContactForm />
        </section>
      </main>
